...
public class HttpRequest implements HttpMessage {
    ...
    public static black.door.net.http.tools.HttpRequest parse(byte[] request) throws IOException, URISyntaxException {
        return parse(new ByteArrayInputStream(request), -1);
    }

    public static black.door.net.http.tools.HttpRequest parse(InputStream is, int maxBodySize) throws IOException, URISyntaxException, HttpParsingException {
        HttpVerb verb;
        URI uri;
        String version;
        ...
        black.door.net.http.tools.HttpRequest ret = new black.door.net.http.tools.HttpRequest(verb, uri, version);
        ret.setBody(body);
    ...
    public black.door.net.http.tools.HttpRequest putHeader(String headerName, String value){
